...
public class Constants {
	...
	public static interface Other{
		public static final String REDIS_USER_KEY = "user_%s_%s";//用户登录redis存储key   user_uuid_openid
		public static final String USER_AVATAR = "layui/images/0.jpg";//用户头像
		public static final String USER_OFFLINE = "offline";//若值为offline代表离线，online或者不填为在线
		public static final String USER_ONLINE= "online";//online或者不填为在线
		public static final String GROUP ="[{\"groupname\":\"管理员\",\"id\":\"2\"},{\"groupname\":\"公司\",\"id\":\"1\"},{\"groupname\":\"个人\",\"id\":\"0\"}]";//分组
		public static final int ADMIN_TYPE=2;//账号类型：  0-个人，1-企业，2-管理员
		public static final int COMPANY_TYPE=1;
		public static final int PERSONAL_TYPE=0;
		public static final String ADMIN_UUID="111";//管理员uuid
	}
